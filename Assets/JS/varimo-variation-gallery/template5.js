        ...
        jQuery(document).ready(function() {
            ...
            function ajaxCallGallery(allImages, useSmootTransition = false) {
                ...
                setTimeout(function() {
                    ...
                    var flexContainer = '<div class="gallery-flex-container">' + lightBoxHtml + mainSliderHtml + thumbnailSliderHtml + '</div>';
            ...
            /**
             * Slick Slider Initialize - Enhanced with smooth settings
             */
            function initializeSlickSliders() {
                ...
                // Initialize Main Slider with smoother settings
