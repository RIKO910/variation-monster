 ...
 *
 */
class VARIMO_Table_Before_AddTo_Cart{
    ...
    public function remove_default_actions() {
        ...
        if ($beforeCartQuickTableOnOff === 'true' && $overwriteDefaultCartTableTemplate === 'template_1'){

            if ($beforeCartVariationTableMeta === 'true'){
        ...
        <script>
            jQuery(document).ready(function ($) {
                ...
                function updateBulkCheckbox() {
                    ...
                    jQuery('.total-price-count').text(varimo_before_one_formated_price(totalPrice));
                }
            ...
            function varimo_before_one_formated_price(amount){
