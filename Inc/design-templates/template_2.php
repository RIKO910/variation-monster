...
<div id="mobile-quick-variable-table">
    ...
    foreach ($varimo_variations as $varimo_var) {
        ...
        ?>
        <div class="mobile-variation-card mobile-variation-card-template-2-design">
            <?php if ($varimoImageHideShow === "true"){
                ?>
                <div style="width: 80px; height: 90px" class="">
            ...
            <div  class="">
                ...
                <?php if ($varimoSkuHideShow === "true"){
                    ?>
                    <div style="text-overflow: ellipsis; overflow: hidden;   white-space: nowrap;  width: 80px;  "><?php echo esc_html($varimo_variation->get_sku()); ?></div>
                    <?php
                }?>
