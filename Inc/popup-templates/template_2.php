...
<div <?php echo esc_attr($varimo_ignore_attr); ?> <?php if ($varimoVariableHoverClick == "" ){ ?> style="display: none" <?php } ?> class="quick-variable-tooltip tooltiptext quick-hidden popup-template-tow-modal">
    <p><span onclick="varimoTemplateCloseButton()" class='closebtn quick-variable-tooltip-closebtn-template-two'>&times;</span></p>

    <div class="content-popup-template-two">
        ...
        <div id="quick-product-details" style="width: 100%">
            <div id="quick-product-content">
                ...
                <?php if (!empty($varimoVariableDetailsTitle) && !empty($varimoVariableSettings)) {
                    ...
                    if ($varimoNameImageRedirect === "true"){
                        ...
                        <a href="#" class="dynamic-variation-url" target="_blank">
                            <h4 style="font-weight: 500" class="<?php if (empty($varimoVariableDetailsTitle) && !empty($varimoVariableSettings)) { echo "quick-hidden"; } ?>"></h4>
                        </a>
                        <?php
                    }else{
                        ?>
                ...
                <p><strong><?php echo esc_html("Price:", 'variation-monster-pro'); ?> </strong><span id="variable-product-price"></span></p>
...
<style>
    ...
    .quick-variable-tooltip-closebtn-template-two{
        top: 6px;
    }

    .content-popup-template-two{
        display: flex;
        flex-direction: row;
    }
